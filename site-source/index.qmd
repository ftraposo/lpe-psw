...
<main id="top">
  ...
  <section class="hero">
    <div class="wrap hero-grid">
      <div class="hero-content">
        ...
        <p class="lede">A one-day workshop bringing together early career researchers working across political economy and political science — now jointly hosted by LSE, UCL, and Cambridge. We intend to run the workshop in the second term of next year, and are currently in the process of securing funding — keep your eyes peeled for updates. If you'd like to be notified once details are confirmed, please <a href="mailto:f.torres-raposo@ucl.ac.uk?subject=Early%20Career%20Workshop">contact us</a>.</p>
        ...
        <div class="hero-meta">
          ...
          <div><span>Venue</span><strong>TBA</strong></div>
          <div><span>Submission deadline</span><strong>TBA</strong></div>
      ...
      <div class="hero-carousel" id="heroCarousel">
        ...
        <button class="carousel-btn prev" onclick="heroCarouselMove(-1)" aria-label="Previous photo">&#8249;</button>
        <button class="carousel-btn next" onclick="heroCarouselMove(1)" aria-label="Next photo">&#8250;</button>
        <div class="carousel-dots">
          <span class="dot active" onclick="heroCarouselGoTo(0)"></span>
          <span class="dot" onclick="heroCarouselGoTo(1)"></span>
          <span class="dot" onclick="heroCarouselGoTo(2)"></span>
        </div>
      </div>
    </div>
  </section>
  ...
  <script>
    ...
    function heroCarouselUpdate() {
      var track = document.querySelector('#heroCarousel .hero-carousel-track');
      track.style.transform = 'translateX(-' + (heroCarouselIndex * 100) + '%)';
      document.querySelectorAll('#heroCarousel .dot').forEach(function(d, i) {
        d.classList.toggle('active', i === heroCarouselIndex);
      });
    }
    function heroCarouselMove(dir) {
      var imgs = document.querySelectorAll('#heroCarousel img');
      heroCarouselIndex = (heroCarouselIndex + dir + imgs.length) % imgs.length;
      heroCarouselUpdate();
    }
  ...
  <section id="themes" class="section-tight">
    <div class="wrap">
      ...
      <p class="body-text">The workshop welcomes theoretical, empirical, and methodological contributions.</p>
      ...
      <div class="theme-grid">
        ...
        <div class="theme-card">
          ...
          <h3>Formal theory &amp; formal modelling</h3>
          <p>Game-theoretic and formal approaches to political and economic behavior.</p>
        </div>
        <div class="theme-card">
    ...
    <div class="wrap">
      ...
      <div class="card-grid">
        ...
        <div class="person-card">
          ...
          <h4>Leo Falabella</h4>
          <p>Department of Political Economy, King's College London</p>
        </div>
        <div class="person-card">
          <img class="avatar-photo" src="images/Profile_2.jpeg" alt="Felipe Torres-Raposo">
          <h4>Felipe Torres-Raposo</h4>
          <p>UCL — Department of Political Science</p>
        </div>
        <div class="person-card">
